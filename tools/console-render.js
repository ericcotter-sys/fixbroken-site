...
function renderAuditPage(audit, slug, opts = {}) {
  ...
  const mailBody = encodeURIComponent(
    ...
    `Full audit: https://fixbroken.ai/free/audit/${slug}/\n\n` +
    `Top fixes:\n` +
...
<meta property="og:url" content="https://fixbroken.ai/free/audit/${slug}/">
...
<nav class="fb-nav">
  <div class="fb-nav__inner">
    ...
    <div class="fb-nav__links">
      ...
      <a class="fb-nav__link" href="/design/">Build</a>
      <a class="fb-nav__link fb-nav__link--active" href="/free/">Free stuff</a>
    </div>
  </div>
</nav>
...
<main class="fb-container" style="padding-top:calc(var(--fb-nav-h) + var(--fb-s-12));">
  ...
  <section class="fb-section">
    ...
    <span class="fb-kicker">Free stuff - Audit</span>
...
function renderVoiceLintPage(lint, slug, opts) {
  ...
  var mailSubject = encodeURIComponent('Jargon Sludge - ' + lint.hitCount + ' banned phrases found');
  var mailBody = encodeURIComponent(
    'Jargon sludge found ' + lint.hitCount + ' banned phrase(s) in our copy.\n\n' +
    'Full result: https://fixbroken.ai/free/voice-lint/' + slug + '/\n\n' +
